    ...
    <Segment style={{ backgroundColor: '#fff', padding: '4em 0em' }} vertical>
      <Container text>
        ...
        <p style={{ textAlign: 'left', fontSize: '1.11em' }}>
            Welcome to the Campus Story Terms of Use agreement. For purposes of this agreement, “App” refers to the Company’s mobile Application, which can be accessed through App Store & Play Store. “Service” refers to the Company’s services accessed via the App, in which users can publish the content for which the user is designated. The terms “we,” “us,” and “our” refer to the Company. “You” refers to you, as a user of our App or our Service. <br/>
            The following Terms of Use apply when you view or use the Service by accessing the Service through clicking on the application (the “App”) on your mobile device.  <br/>
            Please review the following terms carefully. By accessing or using the Service, you signify your agreement to these Terms of Use. If you do not agree to be bound by these Terms of Use in their entirety, you may not access or use the Service.<br/>
        </p>
        
        <b>PRIVACY POLICY</b> <br/>
        
        <p style={{ padding: 10 }}>
        The Company respects the privacy of its Service users. Please refer to the Company’s Privacy Policy (attached with this) which explains how we collect, use, and disclose information that pertains to your privacy. When you access or use the Service, you signify your agreement to the Privacy Policy as well as these Terms of Use.
        </p>
        ...
        <p style={{ padding: 10 }}>
        The Service allows you to publish the content purely generated by you or belong to you or licensed to you. You can upload such content through the Creator’s Studio App which specifically designed for managing your content upload process and keeping track with the users, how they are responding to your content.
        </p>
        
        <b>REGISTRATION; RULES FOR USER CONDUCT AND USE OF THE SERVICE</b> <br/>
        
        <p style={{ padding: 10 }}>
        You need to be at least 16 years of Age to register for and use the Service. <br/>
        ...
        <p style={{ padding: 10 }}>
        Your permission to use the App is conditioned upon the following use, posting and conduct restrictions: <br/>
        You agree that you will not under any circumstances:
        </p>
        <ul>
            <li>
                access the Service for any reason other than your usage for managing , uploading content which is directed into a category your channel will belong to use solely as permitted by the normal functionality of the Service.
            </li>
            <li>
            ...
            <li>
                distribute any part or parts of the App or the Service without our explicit written permission;
            </li>
            <li>
        ...
        <b>POSTING AND CONDUCT RESTRICTIONS</b> <br/>
        <p style={{ padding: 10 }}>
        When you create your own personalized account, you may be able to provide a valid identity proof, the details for channel creation like email, name of the channel, you name etc. (“User Content”) to the Service. You are solely responsible for the User Content that you post, upload, link to or otherwise make available via the Service. <br/>
        You agree that we are only acting as a passive conduit for your online distribution and publication of your User Content. The Company, however, reserves the right to remove any User Content from the Service at its sole discretion.<br/>
        We grant you permission to use and access the Service, subject to the following express conditions surrounding User Content. You agree that failure to adhere to any of these conditions constitutes a material breach of these Terms. <br/>
        By transmitting and submitting any User Content while using the Service, you agree as follows:<br/>
        </p>
        <ul>
        ...
        <p style={{ padding: 10 }}>
            You understand and agree that any liability, loss or damage that occurs as a result of the use of any User Content that you make available or access through your use of the Service is solely your responsibility. The App is not responsible for any public display or misuse of your User Content. <br/>
        ...
        <p style={{ padding: 10 }}>
            Opinions, advice, statements, offers, or other information or content made available through the Service, but not directly by the App, are those of their respective authors, and should not necessarily be relied upon. Such authors are solely responsible for such content. <br/>
        ...
        We may also use your email address to send you other messages, including information about the App or the Service and special offers. You may opt out of such email by changing your account settings, using the “Unsubscribe” link in the message, or by sending an email to info@mycampusdock.com.
        </p>
        ...
        <p style={{ padding: 10 }}>
        TO THE EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE APP, THE SERVICE, ITS AFFILIATES, DIRECTORS, OR EMPLOYEES, OR ITS LICENSORS OR PARTNERS, BE LIABLE TO YOU FOR ANY LOSS OF PROFITS, USE,  OR DATA, OR FOR ANY INCIDENTAL, INDIRECT, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, HOWEVER ARISING, THAT RESULT FROM: (A) THE USE, DISCLOSURE, OR DISPLAY OF YOUR USER CONTENT; (B) YOUR USE OR INABILITY TO USE THE SERVICE; (C) THE SERVICE GENERALLY OR THE SOFTWARE OR SYSTEMS THAT MAKE THE SERVICE AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH USE OR WITH ANY OTHER USER OF THE SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE) OR ANY OTHER LEGAL THEORY, AND WHETHER OR NOT WE HAVE BEEN INFORMED OF THE POSSIBILITY OF SUCH DAMAGE, AND EVEN IF A REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF ITS ESSENTIAL PURPOSE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF LIABILITY, SO THIS PROVISION MAY NOT APPLY TO YOU. <br/>
        If you have a dispute with one or more users, a restaurant or a merchant of a product or service that you review using the Service, you release us (and our officers, directors, agents, subsidiaries, joint ventures and employees) from claims, demands and damages (actual and consequential) of every kind and nature, known and unknown, arising out of or in any way connected with such disputes. <br/>
        ...
        <p style={{ padding: 10 }}>
        If any part of this Terms of Use agreement is held or found to be invalid or unenforceable, that portion of the agreement will be construed as to be consistent with applicable law while the remaining portions of the agreement will remain in full force and effect. Any failure on our part to enforce any provision of this agreement will not be considered a waiver of our right to enforce such provision. Our rights under this agreement survive any transfer or termination of this agreement.<br/>
        You agree that any cause of action related to or arising out of your relationship with the Company must commence within ONE year after the cause of action accrues. Otherwise, such cause of action is permanently barred.<br/>
        We may assign or delegate these Terms of Service and/or our Privacy Policy, in whole or in part, to any person or entity at any time with or without your consent. You may not assign or delegate any rights or obligations under the Terms of Service or Privacy Policy without our prior written consent, and any unauthorized assignment or delegation by you is void.<br/>
        YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE, AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE TERMS OF USE TOGETHER WITH THE PRIVACY POLICY ATTACHED. REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT SUPERSEDES ANY PROPOSAL OR PRIOR AGREEMENT ORAL OR WRITTEN, AND ANY OTHER COMMUNICATIONS BETWEEN US RELATING TO THE SUBJECT MATTER OF THIS AGREEMENT.<br/>
